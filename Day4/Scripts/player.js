...
player.image.src = "Assets/77.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses = {};
player.poses['right'] = new Animation(["Assets/r1.png", "Assets/r2.png"]);
player.poses['left'] = new Animation(["Assets/l1.png", "Assets/l2.png"]);
...
player.draw = function()
{
   ...
   {
       var newFrame = player.poses[player.currentPose];
       player.image = newFrame.getImage()
   }
